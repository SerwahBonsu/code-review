For this problem, you'll be designing a database schema for the basic imdb application you coded in part 2. You can use [SQL designer](http://socrates.devbootcamp.com/sql).
